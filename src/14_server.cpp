 ...
 * ==================================
 * A lightweight Redis-like server implementation featuring:
 * - Key-value storage with hash table backend
 * - Sorted sets (ZSet) with dual AVL tree + hash table structure
 ...
 * - Protocol-compatible subset of Redis commands
 * 
...
/**
 * msg - Print a message to stderr
 * @msg: Message string to print
 * 
 * Simple logging function for debugging and error reporting.
 */
